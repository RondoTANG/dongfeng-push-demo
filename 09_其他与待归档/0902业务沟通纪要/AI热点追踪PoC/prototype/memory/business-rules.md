...
- **业务有效来源**：通过URL、内容与时效清洗，并且当前标题或正文有东风目标品牌关联证据的来源项；不等于所有有效汽车新闻。
...
2. 基础查询覆盖9个品牌和8个行业主题，豆包和Codex均执行。全部结果在进入工作台前按标题和正文核对9个启用品牌；纯他品牌资讯无关联时排除，简称歧义单独记录待核验原因。不把搜索词当证据，不自动触发9品牌收费补采。
...
5. 不启用定时采集；启动服务和访客浏览不得触发付费搜索。完整运行、快速验证和定向补证只能由管理员确认发起。
