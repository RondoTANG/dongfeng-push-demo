...
top_line.fill.solid()
top_line.fill.fore_color.rgb = hex_to_rgb("#E01E2E") # Dongfeng Red
...
p.font.size = Pt(28)
p.font.bold = True
p.font.color.rgb = hex_to_rgb("#111827") # Dark text
...
p.font.size = Pt(14)
p.font.color.rgb = hex_to_rgb("#6B7280") # Medium gray
...
def create_card(left, top, width, height, title, num, items):
    ...
    num_box.fill.solid()
    num_box.fill.fore_color.rgb = hex_to_rgb("#E01E2E")
    ...
    for icon, subtitle, desc in items:
        ...
        p.font.size = Pt(16)
        p.font.bold = True
        p.font.color.rgb = hex_to_rgb("#374151")
        ...
        p.text = desc
        p.font.size = Pt(13)
        p.font.color.rgb = hex_to_rgb("#6B7280")
